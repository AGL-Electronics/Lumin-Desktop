...
// get the version number fro mthe tauri config
...
fn custom_menu_bar() -> SystemTrayMenu {
    // get the version for the app from the cargo.toml
    ...
    let about_menu_data = AboutMetadata::new()
        ...
        .website("https://aglelectronics.com/")
    ...
    SystemTrayMenu::new()
        .add_submenu(SystemTraySubmenu::new("Lumin", app_menu))
